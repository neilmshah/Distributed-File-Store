...
/**
 * Actual datastore server implementation
 */
public class DatabaseDataTransferServiceImpl extends grpc.DataTransferServiceGrpc.DataTransferServiceImplBase {
    ...
    public StreamObserver<FileTransfer.FileUploadData> uploadFile (StreamObserver<FileTransfer.FileInfo> responseObserver){
        return new StreamObserver<FileTransfer.FileUploadData>() {
            ...
            public void onCompleted() {
                ...
                String filename_chunkId = filename+"_"+chunkId;
                fileMap.put(filename+"_"+chunkId,newEntry);
    ...
    private FileTransfer.FileMetaData getChunk(FileTransfer.ChunkInfo req) {
        ...
        //create key
        String fullFileName = fileName+"_"+chunkId.toString();
